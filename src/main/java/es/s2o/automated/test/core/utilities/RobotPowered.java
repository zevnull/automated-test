...
/**
 * <pre>
 * Una forma de forzar la ejecución de "algo" moviendo el mouse y ejecutando un click 
 * Pero SOLO puede utilizarse con una
 * instancia de navegador, ya que utiliza el evento del ratón
 * </pre>
 * 
 * @author s2o
 */
