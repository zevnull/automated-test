 ...
 */
public class EventFiringWebDriverWithSubmit implements WebDriver, JavascriptExecutor, TakesScreenshot, WrapsDriver,
		HasInputDevices, HasTouchScreen {
	...
	public EventFiringWebDriverWithSubmit(final WebDriver driver) {
	 ...
	 */
	public EventFiringWebDriverWithSubmit register(WebDriverEventListener eventListener) {
	 ...
	 * @return this for method chaining.
	 */
	public EventFiringWebDriverWithSubmit unregister(WebDriverEventListener eventListener) {
	...
	private class EventFiringTargetLocator implements TargetLocator {
		...
		public WebDriver parentFrame() {
			return ((EventFiringTargetLocator) targetLocator).parentFrame();
		}
